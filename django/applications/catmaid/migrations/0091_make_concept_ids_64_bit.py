...
forward = """
    ...
    INSERT INTO skeleton_history__history (id, user_id, creation_time,
    ...
    SELECT id, user_id, creation_time, edition_time, project_id, txid,
        ...
        exec_transaction_id
    FROM ONLY skeleton_history__history_old;
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catmaid', '0090_fix_change_request_ids'),
    ]
