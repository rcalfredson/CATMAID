...
forward = """
    ...
    -- Disable history for all conceot tables.
    ...
    -- Disable history views for all relevant tables.
    ...
    CREATE TABLE class_instance (
        ...
        CONSTRAINT class_instance_id_pkey PRIMARY KEY (id),
    ...
    CREATE TABLE stack_class_instance (
        ...
        CONSTRAINT stack_class_instance_id_pkey PRIMARY KEY (id),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('catmaid', '0069_fix_change_request_ids'),
    ]
