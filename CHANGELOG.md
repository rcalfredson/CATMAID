...
- Users can now be set to an inactive state after a specified amount of time.
  This time is configured for a user group and it apples to users if they are
  members of this group. A message can optionally be displayed as well as
  contact users. This is configurable as "Group inactivity period" in the admin
  view. Contact users can be configured either added there or from individual
  user views.
